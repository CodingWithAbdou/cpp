...
int getHowManyPostiveNUmber(int array[100], int size)
{
	int counter = 0;
...
int main() {
	...
	int PositiveCount = getHowManyPostiveNUmber(array, size);
	

	printArray(array, size);

	cout << endl << "Positive number  Count is : " << PositiveCount << endl;
